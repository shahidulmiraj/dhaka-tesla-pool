...
Six tables, each answering a sentence in the PRD. Schema: `apps/api/prisma/schema.prisma`; hand-written constraints: `apps/api/prisma/migrations/20260923000000_init/migration.sql`.
...
Appended to the initial migration:
